    ...
    let app = tauri::Builder::default()
        ...
        .setup(move |app| {
            ...
            #[cfg(desktop)]
            {
                ...
                // On Windows, cmd becomes Win key. If registration fails (e.g., hotkey already taken),
                ...
                if let Err(e) = shortcut.on_shortcut("cmd+shift+h", move |_app, _shortcut, _event| {
                    ...
                    log::warn!("[Tauri] Failed to register global hotkey (Cmd/Win+Shift+H): {e}. Quick launcher hotkey will not be available.");
                }
            }
