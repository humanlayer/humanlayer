...
1. **Read the PR description template:**
   ...
   - If it doesn't exist, inform the user that their `thoughts` setup is incomplete and they need to create a PR description template at `thoughts/pr_description.md`
