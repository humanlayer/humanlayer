---
description: Create a local ticket and PR for experimental features after implementation
---
...
2. read `.claude/commands/tickets.md` — think deeply about what you just implemented, then create a local ticket in `thoughts/tickets/` describing what you did; put it in 'in progress' state with clear "## Problem to solve" and "## Proposed solution" sections
3. derive a short kebab-case branch name from the ticket title
4. git checkout main
