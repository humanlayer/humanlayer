...
function getProvider(documentId: string, electricUrl: string): ElectricProvider {
  ...
  if (!provider) {
    ...
    awareness.on('change', ({ added, updated, removed }) => {
      ...
      console.log(`Current users in document ${documentId}:`, Array.from(states.values()));
    });
...
export function Editor({
  ...
  }, [documentId]); // Add dependency array to prevent recreation
