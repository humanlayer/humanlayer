...
Head over to the [HumanLayer dashboard](https://app.humanlayer.dev) and create a new project to get your API key.
<Frame>
  <img src="https://www.humanlayer.dev/get-token.gif" alt="HumanLayer Get Started" />
</Frame>
</Accordion>
...
<Frame>
  <img src="https://www.humanlayer.dev/approve-tool.gif" alt="Approving a tool call" />
</Frame>
</Accordion>
