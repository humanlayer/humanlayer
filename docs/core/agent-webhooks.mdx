...
You can see an end to end example of using agent webhooks in [Mailcrew](https://github.com/dexhorthy/mailcrew), an open source agent that uses HumanLayer to receive and respond to inbound emails.
