...
In lieu of an in-depth guide, please explore one of the [Typscript examples in the humanlayer repo](https://github.com/humanlayer/humanlayer/tree/main/examples)
