...
export type HotkeyKey = 'SHOW_HELP' | 'SEARCH' | 'COMMAND_PALETTE' | 'CREATE_SESSION' | 'TOGGLE_THEME' | 'NAVIGATE_APPROVALS' | 'NAVIGATE_SESSIONS' | 'JUMP_TO_TOP' | 'JUMP_TO_BOTTOM' | 'TOGGLE_ARCHIVED_VIEW' | 'TOGGLE_ARCHIVED_VIEW_BACK' | 'EXIT_ARCHIVED_VIEW' | 'NAVIGATE_NEXT_EVENT' | 'NAVIGATE_PREVIOUS_EVENT' | 'INTERRUPT_SESSION' | 'APPROVE_REQUEST' | 'DENY_REQUEST' | 'NAVIGATE_DOWN' | 'NAVIGATE_UP' | 'BULK_SELECT_DOWN' | 'BULK_SELECT_UP' | 'SELECT_ALL' | 'OPEN_SESSION' | 'ARCHIVE_SESSION' | 'TOGGLE_SELECTION' | 'OPEN_FORK_VIEW' | 'INSPECT_TOOL_RESULT' | 'COPY_MESSAGE_CONTENT' | 'NAVIGATE_TO_PARENT' | 'ARCHIVE_SESSION_DETAIL' | 'JUMP_TO_BOTTOM_DETAIL' | 'JUMP_TO_TOP_DETAIL' | 'CLOSE_MODAL' | 'AUTO_ACCEPT_EDITS' | 'OPEN_FORK_VIEW_MODAL' | 'FOCUS_INPUT' | 'COPY_CONTENT' | 'COPY_CONTENT_ALT'
