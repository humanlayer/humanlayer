...
export const DraftLauncherForm: React.FC<DraftLauncherFormProps> = ({ session, onSessionUpdated }) => {
	...
	const [, setDangerouslyBypassPermissionsEnabled] = useState(session?.dangerouslySkipPermissions ?? false)
	...
	const handleModelChange = useCallback(
		...
		[setLastUsedProvider, setLastUsedModel, setLastUsedProxyModel, setLastUsedProxyBaseUrl, onSessionUpdated],
	)
	...
	return (
		<HotkeyScopeBoundary scope={HOTKEY_SCOPES.DRAFT_LAUNCHER} componentName="DraftLauncherForm">
			<div className="flex flex-col h-full">
				...
				{/* Status indicator */}
				{sessionId && (title.trim() !== '' || useStore.getState().responseEditor?.getText().trim() !== '') && (
