...
func (m model) buttonView() string {
	...
	if m.selected == 0 {
		greenStyle = greenStyle.Copy().BorderForeground(lipgloss.Color("205"))
	}
	if m.selected == 1 {
		blueStyle = blueStyle.Copy().BorderForeground(lipgloss.Color("205"))
	}
